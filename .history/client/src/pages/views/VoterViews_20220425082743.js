  ...
  render() {
    ...
    if(result === 'Consensus Not Reached'){
      ...
      return(
        ...
        <br />
          /**
            ** If you want a NFT showing that you voted on an amendment that reached consensus within the orginization, please click thisAlso contact your validator so that they can ensure a proper transfer.
          **/
        </div>
