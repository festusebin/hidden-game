    ...
    if(result === 'Consensus Not Reached'){
      ...
      return(
        ...
        <div>
          ...
          <br />{result || 'Unknown'}
          <br />
          If you want a NFT showing that you voted in process reaching majority vote, please clickAlso contact your validator so that they can ensure a proper transfer.
        </div>
      );}
  }
}
